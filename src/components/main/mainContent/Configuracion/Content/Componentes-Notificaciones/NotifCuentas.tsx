...
const NotifCuentas: React.FC = () => {
  ...
  return (
    <div className="flex flex-col pt-5 border-b-2 border-gray-700 pb-10">
      <div>
        <div className="text-xl">Cuentas</div>
      ...
      <div className="flex pt-8">
        ...
        <div>
          <div className="text-lg">Actualizacion Cuentas</div>
          <div className="text-sm text-gray-400">
            Notificarme sobre Actualizaciones datos del cuenta.
          </div>
        </div>
      </div>
    </div>
