...
const NotifArticulos: React.FC = () => {
  const handleSwitchChange = (checked: boolean) => {
    console.log("Switch in NotifArticulos changed to:", checked);
  };

  return (
    <div className="flex flex-col pt-5 border-b-2 border-gray-700 pb-10">
      <div>
        <div className="text-xl">Articulos</div>
      ...
      <div className="flex pt-8">
        ...
        <div>
          <div className="text-lg">Actualizacion Articulos</div>
          <div className="text-sm text-gray-400">
            Notificarme sobre Actualizaciones datos del articulo.
          </div>
        </div>
      </div>
    </div>
