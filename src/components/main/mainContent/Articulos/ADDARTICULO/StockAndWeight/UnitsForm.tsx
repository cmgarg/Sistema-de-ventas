...
const UnitsForm: React.FC<UnitsFormProps> = ({ units, onUnitForm }) => {
  ...
  return (
    <div className="absolute top-0  bottom-0 backdrop-brightness-50 left-0 right-0 flex justify-center items-center z-50">
      <div className="flex flex-col relative h-2/4 w-2/4 bg-slate-950 border text-white border-slate-500 z-50 rounded-lg ">
        {editUnitForm && (
