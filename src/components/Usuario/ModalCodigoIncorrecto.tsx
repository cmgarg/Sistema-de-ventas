...
interface ModalCodigoIncorrectoProps {
  setModalCodigoIncorrecto: (value: boolean) => void;
}

const ModalCodigoIncorrecto: React.FC<ModalCodigoIncorrectoProps> = ({ setModalCodigoIncorrecto }) => {
  return (
